...
const controller = testerlib.SFMCRESTAPIQueriesController;
...
describe("SFMCRESTAPIQueriesController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testRESTContactQuery response", function testRESTContactQueryTest(done) {
        // parameters for the API call
        let contentType = 'application/json';

        controller.getRESTContactQuery(contentType, function callback(error, response, context) {
            // test response code
     ...
     * TODO: Add Description
     */
    it("should testRESTHubQuery response", function testRESTHubQueryTest(done) {
        // parameters for the API call
        let contentType = 'application/json';

        controller.getRESTHubQuery(contentType, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
