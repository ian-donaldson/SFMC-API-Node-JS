...
describe("SFMCAssetsController Tests", function tests() {
     ...
     * TODO: Add Description
     */
    it("should testAssetCollection response", function testAssetCollectionTest(done) {
        // parameters for the API call
        let contentType = 'application/json';

        controller.getAssetCollection(contentType, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
