...
const controller = testerlib.SFMCInteractionsController;
...
describe("SFMCInteractionsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * Get all of the Journey Builder applications.
     */
    it("should testInteractions response", function testInteractionsTest(done) {
        // parameters for the API call
        let contentType = 'application/json';

        controller.getInteractions(contentType, function callback(error, response, context) {
            // test response code
