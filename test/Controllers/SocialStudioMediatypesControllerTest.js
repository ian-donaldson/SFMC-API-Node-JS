...
const controller = testerlib.SocialStudioMediatypesController;
...
describe("SocialStudioMediatypesController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testListMediaTypes response", function testListMediaTypesTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';

        controller.listMediaTypes(accessToken, function callback(error, response, context) {
            // test response code
