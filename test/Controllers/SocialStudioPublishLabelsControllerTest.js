...
const controller = testerlib.SocialStudioPublishLabelsController;
...
describe("SocialStudioPublishLabelsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testListLabelsInAWorkspace response", function testListLabelsInAWorkspaceTest(done) {
        // parameters for the API call
        let workspaceId = '{{ws}}';
        let accessToken = '{{access_token}}';

        controller.listLabelsInAWorkspace(workspaceId, accessToken, function callback(error, response, context) {
            // test response code
     ...
     * TODO: Add Description
     */
    it("should testDeleteLabelsFromAWorkspace response", function testDeleteLabelsFromAWorkspaceTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';

        controller.deleteLabelsFromAWorkspace(accessToken, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
