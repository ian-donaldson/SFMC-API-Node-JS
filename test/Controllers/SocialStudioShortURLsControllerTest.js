...
const controller = testerlib.SocialStudioShortURLsController;
...
describe("SocialStudioShortURLsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testRetrieveShortUrlsInAWorkspace response", function testRetrieveShortUrlsInAWorkspaceTest(done) {
        // parameters for the API call
        let workspace = '{{workspaceId}}';
        let accessToken = '{{access_token}}';

        controller.retrieveShortUrlsInAWorkspace(workspace, accessToken, function callback(error, response, context) {
            // test response code
     ...
     * TODO: Add Description
     */
    it("should testCreateShortURL response", function testCreateShortURLTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';
        let body = {};

        controller.createShortURL(accessToken, body, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
