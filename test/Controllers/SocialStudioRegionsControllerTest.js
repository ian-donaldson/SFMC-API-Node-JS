...
const controller = testerlib.SocialStudioRegionsController;
...
describe("SocialStudioRegionsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testListRegions response", function testListRegionsTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';
        let contentType = 'application/json';

        controller.listRegions(accessToken, contentType, function callback(error, response, context) {
            // test response code
