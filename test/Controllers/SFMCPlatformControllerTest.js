...
const controller = testerlib.SFMCPlatformController;
...
describe("SFMCPlatformController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * Gets endpoint data
     */
    it("should testRetrieveEndpoints response", function testRetrieveEndpointsTest(done) {
        controller.retrieveEndpoints(function callback(error, response, context) {
            // test response code
     ...
     */
    it("should testTokenContext response", function testTokenContextTest(done) {
        controller.getTokenContext(function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
