...
const controller = testerlib.SocialStudioImportedPublishedPostMetricsController;
...
describe("SocialStudioImportedPublishedPostMetricsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testListPostsPostMetrics response", function testListPostsPostMetricsTest(done) {
        // parameters for the API call
        let ostartDate = 1136500800000;
        let startDate = 1136500800;
        let oendDate = 1437105599999;
        let endDate = 1437105599;
        let accessToken = '{{access_token}}';

        controller.listPostsPostMetrics(ostartDate, startDate, oendDate, endDate, accessToken, function callback(error, response, context) {
            // test response code
