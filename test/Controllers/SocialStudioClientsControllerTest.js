...
const controller = testerlib.SocialStudioClientsController;
...
describe("SocialStudioClientsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testListClientDetails response", function testListClientDetailsTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';

        controller.listClientDetails(accessToken, function callback(error, response, context) {
            // test response code
