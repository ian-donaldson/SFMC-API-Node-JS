...
const controller = testerlib.SocialStudioSocialAccountsController;
...
describe("SocialStudioSocialAccountsController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testListSocialProperties response", function testListSocialPropertiesTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';

        controller.listSocialProperties(accessToken, function callback(error, response, context) {
            // test response code
