...
const controller = testerlib.SocialStudioLanguagesController;
...
describe("SocialStudioLanguagesController Tests", function tests() {
    this.timeout(testConfiguration.TEST_TIMEOUT);

    /**
     * TODO: Add Description
     */
    it("should testListLanguages response", function testListLanguagesTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';

        controller.listLanguages(accessToken, function callback(error, response, context) {
            // test response code
     ...
     * TODO: Add Description
     */
    it("should testListLanguageDetails response", function testListLanguageDetailsTest(done) {
        // parameters for the API call
        let accessToken = '{{access_token}}';

        controller.listLanguageDetails(accessToken, function callback(error, response, context) {
            // test response code
            assert.equal(200, context.response.statusCode);
            done();
        });
