...
class SocialStudioClientsController {
    /**
     ...
     * @returns {Promise}
     */
    static listClientDetails(accessToken, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/v3/clients'}`;
...
module.exports = SocialStudioClientsController;
