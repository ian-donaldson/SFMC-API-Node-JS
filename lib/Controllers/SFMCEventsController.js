...
class SFMCEventsController {
     ...
     * @returns {Promise}
     */
    static createFireEvent(contentType, body, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/interaction/v1/events'}`;
     ...
     * @returns {Promise}
     */
    static getEventsRequest(contentType, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _queryBuilder = `${_baseUri}${'/interaction-experimental/v1/events'}`;
...
module.exports = SFMCEventsController;
