...
class SFMCSOAPTrackingEmailController {
    /**
     ...
     * @returns {Promise}
     */
    static createSendRetrieveTrackingUP(contentType, body, callback) {
     ...
     * @returns {Promise}
     */
    static createOpensRetrieveUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createSentRetrieveUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createLinkSendRetrieveUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
...
module.exports = SFMCSOAPTrackingEmailController;
