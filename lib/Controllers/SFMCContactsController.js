...
class SFMCContactsController {
     ...
     * @returns {Promise}
     */
    static getAttributeGroups(contentType, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/contacts/v1/attributeGroups'}`;
    ...
    static getSchemas(contentType, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/contacts/v1/schema'}`;
    ...
    static getDiscovery(contentType, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/contacts/v1/rest'}`;
...
module.exports = SFMCContactsController;
