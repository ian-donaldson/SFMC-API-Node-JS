...
class SFMCAnalyticsController {
     ...
     * @returns {Promise}
     */
    static createAnalyticEvent(contentType, body, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/analytic'}`;
...
module.exports = SFMCAnalyticsController;
