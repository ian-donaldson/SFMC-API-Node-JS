...
class SFMCSOAPDataExtensionsController {
    /**
     ...
     * @returns {Promise}
     */
    static createDataExtensionRowsUpsertUP(contentType, body, callback) {
     ...
     * @returns {Promise}
     */
    static createDataExtensionCreateUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createDataExtensionRowsRetrieveUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
...
module.exports = SFMCSOAPDataExtensionsController;
