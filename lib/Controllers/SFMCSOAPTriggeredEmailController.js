...
class SFMCSOAPTriggeredEmailController {
    /**
     ...
     * @returns {Promise}
     */
    static createTriggeredSendCreateToken(contentType, body, callback) {
     ...
     * @returns {Promise}
     */
    static createTriggeredSendCreateUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
...
module.exports = SFMCSOAPTriggeredEmailController;
