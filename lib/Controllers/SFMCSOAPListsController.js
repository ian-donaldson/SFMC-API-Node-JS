...
class SFMCSOAPListsController {
     ...
     * @returns {Promise}
     */
    static createListRetrieveForSubscriberUP(contentType, body, callback) {
     ...
     * @returns {Promise}
     */
    static createListRetrieveForSubscriberToken(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
...
module.exports = SFMCSOAPListsController;
