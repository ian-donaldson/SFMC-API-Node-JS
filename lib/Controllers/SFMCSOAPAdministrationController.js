...
class SFMCSOAPAdministrationController {
    /**
     ...
     * @returns {Promise}
     */
    static createReturnAllMCAccountObjects(contentType, sOAPAction, body, callback) {
...
module.exports = SFMCSOAPAdministrationController;
