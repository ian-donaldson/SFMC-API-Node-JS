...
class SFMCSOAPSubscribersController {
    /**
     ...
     * @returns {Promise}
     */
    static createSubscribersRetrieveToken(contentType, body, callback) {
     ...
     * @returns {Promise}
     */
    static createSubscriberCreateUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createSubscriberRetrieveUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
...
module.exports = SFMCSOAPSubscribersController;
