...
class SocialStudioRegionsController {
    /**
     ...
     * @returns {Promise}
     */
    static listRegions(accessToken, contentType, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/v3/regions'}`;
...
module.exports = SocialStudioRegionsController;
