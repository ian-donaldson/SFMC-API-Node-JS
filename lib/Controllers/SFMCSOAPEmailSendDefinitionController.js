...
class SFMCSOAPEmailSendDefinitionController {
    /**
     ...
     * @returns {Promise}
     */
    static createEmailSendDefintionCreateUP(contentType, body, callback) {
     ...
     * @returns {Promise}
     */
    static createEmailSendDefintionPerformUP(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
...
module.exports = SFMCSOAPEmailSendDefinitionController;
