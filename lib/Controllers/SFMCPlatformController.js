...
class SFMCPlatformController {
     ...
     * @returns {Promise}
     */
    static retrieveEndpoints(callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/platform/v1/endpoints'}`;
     ...
     * @returns {Promise}
     */
    static getTokenContext(callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _queryBuilder = `${_baseUri}${'/platform/v1/tokenContext'}`;
...
module.exports = SFMCPlatformController;
