...
class SocialStudioSocialAccountsController {
    /**
     ...
     * @returns {Promise}
     */
    static listSocialProperties(accessToken, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/v3/socialProperties'}`;
...
module.exports = SocialStudioSocialAccountsController;
