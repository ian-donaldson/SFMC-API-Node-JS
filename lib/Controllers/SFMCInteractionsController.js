...
class SFMCInteractionsController {
    /**
     ...
     * @returns {Promise}
     */
    static getInteractions(contentType, callback) {
        ...
        const _queryBuilder = `${_baseUri}${'/interaction/v1/interactions'}`;
...
module.exports = SFMCInteractionsController;
